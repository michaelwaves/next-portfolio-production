...
export default function PopupCloset({ reduxProperty, children }: { reduxProperty: string, children: React.ReactNode }) {
    ...
    return (
        <motion.div
            ...
            <div
                ...
                <span className="absolute top-2 right-2 z-50" onClick={e => handleClose(e)}>
