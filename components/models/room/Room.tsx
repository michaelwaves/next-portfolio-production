...
import { toggleState, toggleStatePopup as toggleClosetPopup, getState as getCloset } from '@/redux/closetSlice'
import { toggleState as toggleDesk, toggleStatePopup, getState } from '@/redux/deskSlice'
import { handleLights as reduxLights, toggleState as toggleControls, getState as getControls, setHovered } from '@/redux/controlsSlice'
...
export function Room(props: JSX.IntrinsicElements['group']) {
  ...
  const controlsState = useAppSelector(getControls)
  const deskState = useAppSelector(getState)
  ...
  */
  ...
  const handlePointerEnter = () => {
    reduxDispatch(setHovered("hoverSmall"))
  }
  const handlePointerOut = () => {
    reduxDispatch(setHovered("unhover"))
  }
      ...
      <group name="Scene">
        ...
        {/*<Selection>
           <EffectComposer multisampling={2} autoClear={false}>
            <Outline blur visibleEdgeColor={colors.white} edgeStrength={10} width={10000} />
          </EffectComposer> 
          <Select enabled={hovered === 'shiba'}>*/}
        ...
        >
          ...
          <mesh name="note008" geometry={nodes.note008.geometry} material={materials.notes} onPointerEnter={handlePointerEnter}
            onPointerOut={handlePointerOut} />
        ...
        <animated.mesh onClick={(e) => handleClick(e)} position-x={desk_6} name="desk_6" geometry={nodes.desk_6.geometry} material={materials['gray.001']}>
          ...
          <group name="piano"
            onPointerEnter={handlePointerEnter}
            onPointerOut={handlePointerOut}
            onClick={(e) => { e.stopPropagation(), reduxDispatch(toggleDesk("piano")), reduxDispatch(toggleControls("pauseMusic")) }}>
        ...
        <animated.mesh name="desk_2" onClick={(e) => handleClick(e)} position-x={desk_2} geometry={nodes.desk_2.geometry} material={materials['gray.001']}>
          ...
          <mesh name="riseDesk" geometry={nodes.desk_legs.geometry} material={materials['gray.001']}
            onPointerEnter={handlePointerEnter}
            onPointerOut={handlePointerOut}
            onClick={(e) => { e.stopPropagation(), reduxDispatch(toggleDesk("riseDesk")) }}>
            <group name="risedesk" >
        ...
        <mesh
          onPointerEnter={handlePointerEnter}
          onPointerOut={handlePointerOut}
          onClick={(e) => handleLights(e)} name="silver_lamp" geometry={nodes.silver_lamp.geometry} material={materials['gray.003']} />
        ...
        <mesh
          onPointerEnter={handlePointerEnter}
          onPointerOut={handlePointerOut}
          onClick={(e) => handleLights(e)} name="lampshade" geometry={nodes.lampshade.geometry} material={materials.yellow} />
        <mesh
          onPointerEnter={handlePointerEnter}
          onPointerOut={handlePointerOut}
          onClick={(e) => handleLights(e)} name="nightstand_lamp" geometry={nodes.nightstand_lamp.geometry} material={nodes.nightstand_lamp.material} />
        ...
        <group name="backpack002"
          onPointerEnter={handlePointerEnter}
          onPointerOut={handlePointerOut}
          onClick={(e) => { e.stopPropagation(), reduxDispatch(toggleClosetPopup("domainbag1")) }}>
        ...
        <group name="backpack003"
          onPointerEnter={handlePointerEnter}
          onPointerOut={handlePointerOut}
          onClick={(e) => { e.stopPropagation(), reduxDispatch(toggleClosetPopup("domainbag2")) }}>
        ...
        <group name="backpack004"
          onPointerEnter={handlePointerEnter}
          onPointerOut={handlePointerOut}
          onClick={(e) => { e.stopPropagation(), reduxDispatch(toggleClosetPopup("domainbag3")) }}>
        ...
        <animated.mesh name="devpost"
          geometry={nodes.devpost.geometry} material={materials.hackathons} position-z={devpost_}
