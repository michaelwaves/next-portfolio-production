...
export default function Rotman() {
    ...
    return (
        <motion.div
            ...
            <div className=' absolute right-4 top-4' onClick={(e) => handleClick(e)}>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="text-black w-12 h-12 justify-self-end cursor-pointer hover:text-white">
            ...
            <div className='body-sides'>
                <div className=' body-bg'>
                    ...
                    <img src="/images/rotman.jpg" alt="" />
                    <h2 className="mt-10">High School</h2>
