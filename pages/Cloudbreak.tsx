    ...
    return (
        <motion.div
            ...
            <div className="tldr-box">
                <img src="/images/cloudbreak/cloudbreaklanding.png" alt="landing page" className="object-cover md:w-1/2 w-full" />
            ...
            <div className='body-sides'>
                <div className=' body-bg'>
                    ...
                    <img src="/images/cloudbreak/cbt009.png" alt="" />
                    <div className='flex flex-col items-center justify-center m-auto'>
                        ...
                        <ul className='list-disc'>
                            ...
                            <li>Created videos and media for LinkedIn posts</li>
